...
if (isset($_GET['genreport'])) {
    ...
    //echo $caseId;
    $loadUrl = $GLOBALS['webroot'] . "/genreport.php?pid=" . $pid . "&catid=" . $catid . "&prdid=" . $prdid . "&frdt=" . $frdt."&fname=checkoutsheetpainmgmt";
...
<head>
    <title><?php echo xlt('Checkoutsheet Pain MGMT'); ?></title>
    ...
    <form method='post' name='theform' id='theform' onsubmit='return top.restoreSession()'>
        ...
        <div id="report_parameters">
            ...
            <div class="page-title">
                <h2><?php echo xlt('Checkoutsheet Pain MGMT'); ?></h2>
            </div>
