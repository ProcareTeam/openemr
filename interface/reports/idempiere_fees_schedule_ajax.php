...
function getMWPROData($connection) {
	global $params, $code1, $ad_client_id;
    $returnData = array();
    ...
    $sql_query = "SELECT mp.value as code_1, mp.description, (select mm.pricestd from m_pricelist_version ver,m_productprice mm where ver.m_pricelist_version_id = mm.m_pricelist_version_id and mm.m_product_id = mp.m_product_id and ver.description ='A' and ver.isactive='Y') as amount_a, (select mm.pricestd from m_pricelist_version ver,m_productprice mm where ver.m_pricelist_version_id = mm.m_pricelist_version_id and mm.m_product_id = mp.m_product_id and ver.description ='B' and ver.isactive='Y') as amount_b, (select mm.pricestd from m_pricelist_version ver,m_productprice mm where ver.m_pricelist_version_id = mm.m_pricelist_version_id and mm.m_product_id = mp.m_product_id and ver.description ='C' and ver.isactive='Y') as amount_c, (select mm.pricestd from m_pricelist_version ver,m_productprice mm where ver.m_pricelist_version_id = mm.m_pricelist_version_id and mm.m_product_id = mp.m_product_id and ver.description ='D' and ver.isactive='Y') as amount_d, (select mm.pricestd from m_pricelist_version ver,m_productprice mm where ver.m_pricelist_version_id = mm.m_pricelist_version_id and mm.m_product_id = mp.m_product_id and ver.description ='E' and ver.isactive='Y') as amount_e, (select mm.pricestd from m_pricelist_version ver,m_productprice mm where ver.m_pricelist_version_id = mm.m_pricelist_version_id and mm.m_product_id = mp.m_product_id and ver.description ='F' and ver.isactive='Y') as amount_f, (select mm.pricestd from m_pricelist_version ver,m_productprice mm where ver.m_pricelist_version_id = mm.m_pricelist_version_id and mm.m_product_id = mp.m_product_id and ver.description ='G' and ver.isactive='Y') as amount_g, (select mm.pricestd from m_pricelist_version ver,m_productprice mm where ver.m_pricelist_version_id = mm.m_pricelist_version_id and mm.m_product_id = mp.m_product_id and ver.description ='H' and ver.isactive='Y') as amount_h, mp.isactive as inactive, mp.pc_ispatientresponsible as patient_only_responsible, mp.created as date_created, (select adu.name from ad_user adu where mp.updatedby = adu.ad_user_id limit 1) as user_code, mp.updated as date_modified, mp.classification as type from m_product mp ";

    $whereQtr = "WHERE mp.ad_client_id=".$ad_client_id." ";
