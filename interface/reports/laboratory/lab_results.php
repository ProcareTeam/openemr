		...
		<div id="report_parameters">
			<table>
				<tr>
								...
								<td style="line-height: 22px">
									...
									<div style="float: left; margin-right: 20px; margin-bottom: 5px">
										...
										<input type='text' name='form_from_date' id="form_from_date"
											...
											title='yyyy-mm-dd' class='form-control datepicker'> <!-- <img src='../../pic/show_calendar.gif'
					...
					<td style="vertical-align:middle;text-align:center;height:100%;padding-right:20px;min-width:<?php echo ($form_refresh)? '200px' : '180px' ?>">
						<?php if ($form_refresh) { ?>
