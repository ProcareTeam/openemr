...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $webroot ?>/library/js/fancybox-1.3.4/jquery.fancybox-1.3.4.css" media="screen" />
		...
		<div id="report_parameters">
			<table>
				<tr>
								...
								<td style="line-height: 22px">
									<div style="float: left; margin-right: 20px; margin-bottom: 5px">
										...
										<?php
											...
											echo "   <select name='form_facility' style='max-width:200px' class='form-control'>\n";
									...
									<div style="float: left; margin-right: 20px; margin-bottom: 5px">
										...
										<?php
											...
											echo "   <select name='form_provider' style='max-width:200px' class='form-control'>\n";
									...
									<div style="float: left; margin-right: 20px; margin-bottom: 5px">
										...
										<?php
											...
											echo "   <select name='form_processor' class='form-control'>\n";
									...
									<div style="float: left; margin-right: 20px; margin-bottom: 5px">
										...
										<input type='text' name='form_from_date' id="form_from_date"
											size='10' value='<?php echo $form_from_date ?>' class='datepicker form-control' 
									...
									<div style="float: left; margin-right: 20px; margin-bottom: 5px">
										...
										<input type='text' name='form_to_date' id="form_to_date"
											size='10' value='<?php echo $form_to_date ?>' class='datepicker form-control' 
											onkeyup='datekeyup(this,mypcc)' onblur='dateblur(this,mypcc)'
											title='yyyy-mm-dd'> <!-- <img src='../../pic/show_calendar.gif'
									...
									<div style="float: left; margin-right: 20px; margin-bottom: 5px">
										...
										<?php
											...
											echo "   <select name='form_handling' class='form-control'>\n";
											echo "    <option value=''>-- " . xl('All') . " --\n";
									...
									<div style="float: left; margin-right: 20px; margin-bottom: 5px">
										...
										<?php
											...
											echo "   <select name='form_billing' class='form-control'>\n";
											echo "    <option value=''>-- " . xl('All') . " --\n";
											while ($urow = sqlFetchArray($ures)) {
												$statid = $urow['option_id'];
												echo "    <option value='$statid'";
					...
					<td style="vertical-align:middle;text-align:center;height:100%;padding-right:20px;min-width:<?php echo ($form_refresh)? '250px' : '180px' ?>">
						<?php if ($form_refresh) { ?>
						<div style='float: right'>
							<a href='#' class='css_button ml-1' onclick='window.print()'> 
