    ...
    <div style='float:left'>
      ...
      <table class='text'>
        <tr>
          ...
          <td>
	    <?php dropdown_facility($form_facility, 'form_facility', true); ?></td>
...
<?php } else { ?>
Calendar.setup({inputField:"form_from_date", ifFormat: '<?php echo $date_fmt; ?>', button:"img_from_date"});
Calendar.setup({inputField:"form_to_date", ifFormat: '<?php echo $date_fmt; ?>', button:"img_to_date"});
<?php } ?>
