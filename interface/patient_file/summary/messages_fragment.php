...
<div class="clearfix pt-2">
	<ul class="tabNav">
		...
		<li><a id="header_tab_chat" href="#"><?php echo htmlspecialchars(xl('Chat'),ENT_NOQUOTES); ?></a></li>
	</ul>
	...
	<div class='tabContainer'>
		...
		<!-- CHAT BOARD -->
		<div id='chat_board' class="tab mb-0 px-0">
			<div class="msg-tab-container">
				<table id="chat_board_table" class="text table table-sm msg-table tableRowHighLight" style="width:100%">
					<thead>
						<tr>
							<?php
