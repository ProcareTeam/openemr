...
//Change
if(empty($order_data->provider_id)) $order_data->provider_id = 0;
if(empty($order_data->encounter_id)) $order_data->encounter_id = 0;
if(empty($order_data->order_priority)) $order_data->order_priority = '';
if(empty($order_data->order_status)) $order_data->order_status = '';
if(empty($order_data->activity)) $order_data->activity = 1;
if(empty($order_data->order_abn)) $order_data->order_abn = 'not_required';
if(empty($order_data->collector_id)) $order_data->collector_id = 0;
...
// create test records
if (isset($test_code) && !empty($test_code)) {
