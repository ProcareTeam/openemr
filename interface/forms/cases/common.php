...
// Log if make case inactive
if ($form_mode == "save" || $form_mode == "updatenotes") {
    $oldCaseData = sqlQuery("SELECT * FROM $frmn WHERE id=?",array($id));
}
...
//OEMR - Add
include_once($GLOBALS['fileroot'].'/interface/forms/cases/includes/case_update_future_appt.php');
