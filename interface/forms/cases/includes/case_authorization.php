                ...
                <div class="form-row">
                  ...
                  <div class="form-row">
                    <div class="form-group col-lg-6">
                        <label><?php echo xl('Authorization Notes'); ?>:</label>
                    ...
                    <div class="form-group col-lg-6">
                      <label><?php echo xl('Prior Auth'); ?>:</label>
                      <div class="forminput-inline-field">
                        <input type="text" name="<?php echo $field_prefix; ?>prior_auth_number" id="<?php echo $field_prefix; ?>prior_auth_number" class="form-control" placeholder="Prior Auth Number" value="<?php echo htmlspecialchars($dt[$field_prefix . 'prior_auth_number'],ENT_QUOTES); ?>">
                      </div>
                    </div>
                  </div>
            </div>
