...
/*
* Changes Added in Query to get Primary Payer 
* By Sandeep
*/
$cases = array();
$sql = 'SELECT form_cases.*, (SELECT COUNT(*) FROM case_appointment_link AS ca ' .
			...
			<div class="table-responsive table-container datatable-container c-table-bordered footer-p o-overlay text">
				<table id="case_list" class="table table-striped text table-sm mt-0" class="border-0 display">
					...
					<tr>
						...
						<th scope="col"><?php echo xl('Primary Payer'); ?></th>
					...
					?>
							<tr style="" onclick="<?php echo $onClickRow; ?>">
								...
								<td class="align-middle" <?php echo $mode == 'choose' ? $choose_href : ''; ?> >&nbsp;<?php echo htmlspecialchars($case['payer'], ENT_QUOTES); ?></td>
