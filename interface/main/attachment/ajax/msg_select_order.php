...
$records = Attachment::getRawOrderDataForSelection(array('pid' => $pid, 'search' => $searchValue), 'count(*) as allcount');
...
$recordData = Attachment::getOrderDataForSelection(array('pid' => $pid, 'search' => $searchValue), 'fr.*', $columnName, $columnSortOrder, $row, $rowperpage);
