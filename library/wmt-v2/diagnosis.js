...
function SetSelectCurrentDiagnosis(base,wrap,formID,mode,encounter) {
	var target = '../../../custom/diag_code_popup2.php?encounter='+encounter+'&base='+base+'&wrap='+wrap+'&formID='+formID+'&mode='+mode;
