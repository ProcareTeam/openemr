...
?>
		<td class="wmtCollapseBar wmtBorder1B" colspan="3">
		...
		<div style="float: right; padding-right: 10px;"><a href="javascript:;" class='css_button_small' tabindex='-1' onClick="return SubmitLinkBuilder('<?php echo $base_action; ?>','<?php echo $wrap_mode; ?>','','<?php echo $id; ?>','linklatestallhist');" ><span><?php xl('Sync Medication History','e'); ?></span></a></div>
