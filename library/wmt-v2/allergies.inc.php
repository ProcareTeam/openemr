...
<?php } ?>
	...
	<?php } ?>
			...
			<div style="float: right; padding-right: 10px;"><a href="javascript:;" class='css_button_small' tabindex='-1' onClick="return SubmitLinkBuilder('<?php echo $base_action; ?>','<?php echo $wrap_mode; ?>','<?php echo ($cnt); ?>','<?php echo $id; ?>','linklatestallergies');" ><span><?php xl('Sync Allergies','e'); ?></span></a></div>
		</td>
	</tr>
	<tr>
