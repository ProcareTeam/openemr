...
?>
			...
			<div style="float: right; padding-right: 0px;"><a href="javascript:;" class='css_button_small' tabindex='-1' onClick="return SubmitLinkBuilder('<?php echo $base_action; ?>','<?php echo $wrap_mode; ?>','','<?php echo $id; ?>','unlinkallmeds');" ><span><?php xl('Un-Link ALL Prescriptions','e'); ?></span></a></div>

			<div style="float: right; padding-right: 10px;"><a href="javascript:;" class='css_button_small' tabindex='-1' onClick="return SubmitLinkBuilder('<?php echo $base_action; ?>','<?php echo $wrap_mode; ?>','','<?php echo $id; ?>','linklatestallmeds');" ><span><?php xl('Sync  Prescriptions','e'); ?></span></a></div>
