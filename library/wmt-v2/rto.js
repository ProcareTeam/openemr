...
function SendExternalReminderRTO(itemID,pid,orderID) {
	dlgopen(top.webroot_url + '/interface/forms/rto1/send_external_reminder.php?pid=' + pid + '&orderId=' + orderID, 'sendexternal', '300', '150', false, 'Send External Reminder');
}
