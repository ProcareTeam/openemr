...
class Template {
	...
	public function Merge($elements, $raw = FALSE, $preventImageReplace = true) {
		...
		if(class_exists('\Vitalhealthcare\OpenEMR\Modules\Generic\Controller\FormController')) {
			\Vitalhealthcare\OpenEMR\Modules\Generic\Controller\FormController::getTokenLink($this->html_tags, $elements);
		}
