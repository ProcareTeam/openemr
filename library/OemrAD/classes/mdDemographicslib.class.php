...
class Demographicslib {
	...
	public static function dem_layout_tabs($group_name_esc, $group_fields = array()) {
		global $pid;
	...
	// @VH: Log the value change data [V100051]
	public static function dem_after_save($mode = '') {
		global $pid;
