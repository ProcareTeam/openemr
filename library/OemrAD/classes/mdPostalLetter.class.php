...
class PostalLetter {
	...
	public static function getConfigVars() {
		...
		$letterSecretKey = $cryptoGen->decryptStandard($GLOBALS['POSTAL_LETTER_SECRETKEY']);
		...
		$returnList->postal_letter_secretkey = isset($letterSecretKey) ? $letterSecretKey : "";

		return $returnList;
	}
    
    public static function getAndSaveEncounterPDF($pid, $queryData, $filename = 'postal_letter_encounters_and_forms') {
    ...
    public static function Transmit($postal_letterData) {
		...
		if($letterData['status'] == true) {
			...
			$qtrParams = array(
				...
				'sendToAddress.Name' => $postal_letterData['receiver_name'],
				'isDoubleSided' => 'false',
				'isColored' => 'false',
	...
	public static function getAfterResponce($letterId) {
		$messages = array();
		$prepareData = array(
			'id' => $letterId
		);
	...
	*/
	...
	public static function displayPostalLetterPDF($data) {
	...
	public static function setupGlobalFieldScript(){
		?>
	...
	public static function getPostalLetterAddr($data) {
	...
	public static function checkIsError1($data) {
	...
	public static function isFailedToSend1($data) {
		$isFailed = false;
