...
class FaxMessage {
	...
	public static function getConfigVars() {
		...
		$faxpass = $cryptoGen->decryptStandard($GLOBALS['FAX_PASS']);

		$returnList->fax_user = isset($GLOBALS['FAX_USER']) ? $GLOBALS['FAX_USER'] : "";
		$returnList->fax_pass = isset($faxpass) ? $faxpass : "";
	...
	public static function getEncouterList($pid) {
	...
	*/
	...
	public static function getAndSaveEncounterPDF($pid, $queryData, $filename = 'fax_encounters_and_forms') {
	...
	public static function Transmit($faxData) {
		...
		if(empty($GLOBALS['FAX_USER']) || empty($faxpass)) {
			return array(
				'status' => false,
	...
	public static function getFaxMessageList($pid, $activity = 1) {
