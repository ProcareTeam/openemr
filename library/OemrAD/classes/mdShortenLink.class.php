...
class ShortenLink {
	...
	public static function getConfigVars() {
		...
		$returnList->access_token = isset($GLOBALS['shortenlink_access_token']) ? $cryptoGen->decryptStandard($GLOBALS['shortenlink_access_token']) : "";
		...
		$returnList->shortenlink_password = isset($GLOBALS['shortenlink_password']) ? $cryptoGen->decryptStandard($GLOBALS['shortenlink_password']) : "";
